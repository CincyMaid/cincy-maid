...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Yes. Cincy Maid uses professional-grade, non-toxic cleaning products on every job. They are safe for children, pets, and anyone with sensitivities. If you have a preference for a specific product, let us know at booking and we will accommodate it." },
    },
    {
      "@type": "Question",
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-6 text-charcoal-light text-lg leading-relaxed">
            ...
            <p>
              All Cincy Maid cleaners are background-checked, fully insured, and trained to a consistent standard. If anything is missed, we come back within 24 hours and fix it at no charge.
            </p>
          </div>
